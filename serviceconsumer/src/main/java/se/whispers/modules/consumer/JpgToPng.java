...
public class JpgToPng {
    public void convertJpgToPng(String inputFile, String outputFile) throws ImageConverterException {
        ...
        imageConverter = imageConverters.stream()
                .filter(service -> service.type().getName().equals("se.whispers.modules.serviceprovider.imageconverter.JpgToPngConverter"))
                .findFirst()
